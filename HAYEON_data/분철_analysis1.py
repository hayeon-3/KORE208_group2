...
# 6. 저장
result_df.to_csv("HAYEON_data/char_count_분철연철.csv", index=False, encoding='utf-8-sig')
...
filtered_df.to_csv("HAYEON_data/char_count_분철연철_cleaned.csv.csv", index=False, encoding='utf-8-sig')
filtered_df.head()
